...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.action_view_content.setEnabled(False)
        self.action_view_content.setCheckable(True)
        self.action_view_content.setChecked(True)
        self.action_view_content.triggered.connect(self.menu_action_view_content)
